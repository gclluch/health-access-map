...
export default function SearchBox() {
  ...
  return (
    <form onSubmit={submit} className="relative">
      <input
        className="num w-[150px] max-[520px]:w-[118px] bg-surface/90 border border-hairline rounded px-2.5 py-1.5 text-[13px] text-ink focus:border-accent max-[520px]:min-h-[40px]"
